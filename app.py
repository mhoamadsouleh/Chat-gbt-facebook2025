...
FACEBOOK_PAGE_ACCESS_TOKEN = 'EAARRlvmJ1MMBO8tnkpw0CgjZAgfGq9H2ekxQl8yClhzcMHNNWvgdwlBL3zNZAg8bzs3NBmQ9VDNronmCAQwG3zApXM7u0WtEzIgigyBkRUgg3MCQKL8oYyqKmPf5Ff1Rq23Qc5njfpc2X2hIhZC2ZCLawvlxeaJVBfeKe2y0H9jjMxZAj89ZCpL8H2ebE1MzRwkMhz5qAaowZDZD'
...
def webhook():
    if request.method == 'GET':
        ...
        if verify_token == 'YOUR_VERIFY_TOKEN':  # استبدل بالتوكن الخاص بك
            return challenge
...
def health_check():
    return jsonify({'status': 'healthy', 'running': running})
...
if __name__ == '__main__':
    print("🚀 Starting Facebook Bot with Flask...")
    print("🤖 Bot is now running and monitoring webhooks...")
    
    # بدء المهام الخلفية
    start_background_tasks()
    
    # تشغيل تطبيق Flask
    app.run(host='0.0.0.0', port=5000, debug=False)    '😢': ['لا تحزن 😢', 'الله يعين', 'كل شيء سيكون بخير'],
    '😡': ['اهدأ 🫂', 'لا تغضب', 'الغضب لا يحل المشاكل'],
    '❤️': ['❤️❤️', 'الله يسلمك', 'يا قلبو'],
    '👍': ['👍👍', 'تم يا بطل', 'الله يقويك'],
    '👏': ['👏👏', 'برافو عليك', 'مبدع'],
